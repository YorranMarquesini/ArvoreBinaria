...
public class BinaryTreeMenu {
 ...
 // Remoção
    ...
    public void printTree(Node root) {
        int maxLevel = altura(root) + 1;
        printTreeInternal(java.util.Collections.singletonList(root), 1, maxLevel);
    }

    private void printTreeInternal(java.util.List<Node> nodes, int level, int maxLevel) {
    ...
    private boolean allElementsNull(java.util.List<Node> list) {
        for (Node node : list)
            if (node != null)
                return false;
        return true;
 ...
 // Verifica se é completa
    ...
    public static void main(String[] args) {
    	BinaryTreeMenu arvore = new BinaryTreeMenu();
        ...
        do {
            ...
            System.out.println("12. Exibir árvore em formato pirâmide");
            ...
            switch (opcao) {
                ...
                case 11:
                    ...
                    break;
                case 12:
                    System.out.println("Representação visual da árvore:");
